...
public class AddItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price_input.addTextChangedListener(new CheckDecimal(price_input, maxDecimalPlaces));
    ...
    void confirmDialog() {
        ...
        builder.setMessage("Do you want to delete " + name + " ?"+" This action cannot be undone.");
